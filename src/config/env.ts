...
/** When false, protected routes and 401 handlers do not force login (dev/demo). */
function requireAuthFromEnv(): boolean {
  const raw = (import.meta.env.VITE_REQUIRE_AUTH as string | undefined)?.toLowerCase()
